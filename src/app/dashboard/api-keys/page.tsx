          ...
          {loading? <div className="p-8 text-center text-[13px] text-slate-400">Loading...</div> : (
            <div className="mt-4 space-y-3">
              ...
              <form onSubmit={handleSave} className="pt-4 border-t space-y-3">
                ...
                <button type="submit" className="w-full h-11 rounded-full bg-violet-600 text-white text-[13px] font-semibold">Save Encrypted Securely</button>
