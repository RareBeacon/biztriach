...
export default function ExpensesPage(){
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center"><div><h1 className="font-outfit text-[26px] font-bold">Expense Tracking</h1><p className="text-[13px] text-slate-500">Track rent, fuel, transport, salary, electricity, purchases. AI auto-reports.</p></div><button onClick={()=>setShowAdd(true)} className="h-10 px-5 rounded-full bg-violet-600 text-white text-[13px] font-medium flex items-center gap-2"><Plus className="w-4 h-4"/> Add Expense</button></div>
