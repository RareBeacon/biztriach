...
export default function CustomersPage(){
  ...
  return(
    <div className="space-y-6">
      <div className="flex justify-between items-center"><div><h1 className="font-outfit text-[26px] font-bold">Customers</h1><p className="text-[13px] text-slate-500">Track top customers, spending, outstanding payments.</p></div><button onClick={()=>setShowAdd(true)} className="h-10 px-5 rounded-full bg-violet-600 text-white text-[13px] font-medium flex items-center gap-2"><Plus className="w-4 h-4"/> Add Customer</button></div>
